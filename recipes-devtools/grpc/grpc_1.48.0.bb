SUMMARY = "Elk OS requires 1.48.0 for Grpc"
...
S = "${WORKDIR}/git"
SRCREV_grpc = "d2054ec6c6e8abcecf0e24b0b4ee75035d80c3cc"
SRC_URI = "\
    gitsm://github.com/grpc/grpc.git;protocol=https;name=grpc;nobranch=1 \
